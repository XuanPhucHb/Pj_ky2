...
<header class="header">
    <nav class="navbar navbar-expand-lg"
         style="background-color: #000;box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.4), 0 6px 20px 0 rgba(0, 0, 0, 0.19);color: #fff;">
        <div class="container-fluid d-flex align-items-center justify-content-between">
            <div class="navbar-header">
                ...
                <!-- Sidebar Toggle Btn-->
                <button style="color: red;font-weight: bolder;" class="sidebar-toggle"><i
            ...
            <div class="right-menu list-inline no-margin-bottom">
                ...
                <!-- Log out               -->
                <div class="list-inline-item logout"><a id="logout" style="color: red;font-weight: bolder;"
                                                        href="{{ route('logout') }}" class="nav-link" onclick="event.preventDefault();
...
<div class="d-flex align-items-stretch">
    <!-- Sidebar Navigation-->
    <nav id="sidebar"
         style="background-color:rgb(10,10,10);box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.4), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">
        <!-- Sidebar Header-->
        ...
        <ul class="list-unstyled">
            ...
            <li><a href="{{asset("/admin/actor")}}"> <i class="fa fa-user" aria-hidden="true"></i>Actor </a></li>
            <li><a href="{{asset("/admin/actress")}}"> <i class="fa fa-female" aria-hidden="true"></i>Actress </a></li>
    ...
    <div class="page-content"
         style="background-color:#222222;box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.4), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">
