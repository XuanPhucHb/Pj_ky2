							...
							<ul class="header__nav">
								...
								<li class="header__nav-item">
									...
									<ul class="dropdown-menu header__dropdown-menu" aria-labelledby="dropdownMenuCatalog">
										<li><a href="catalogs/catalog1.blade.php">Catalog Grid</a></li>
										<li><a href="catalogs/catalog2.blade.php">Catalog List</a></li>
										<li><a href="details/details1.blade.php">Details Movie</a></li>
										<li><a href="details/details2.blade.php">Details TV Series</a></li>
									</ul>
								</li>
								<!-- end dropdown -->

								<li class="header__nav-item">
									<a href="pricing.blade.php" class="header__nav-link header__nav-link--active">Pricing Plan</a>
								</li>
